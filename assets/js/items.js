...
const products = [
  // CIFROVIE SYSTEM
  {
    ...
    description: `Маммографическая цифровая DR система с функцией RIS / PACS. Комплектация:
    ...
    subProducts: [
      {
        ...
        description: "Ретрофит комплект с принадлежностями для модернизации любого аналогового рентген аппарата в цифровой вариант исполнения DR, с набором программных средств и модулем интеграции с МИС, собственной базой данных RIS/PACS, предназначенные для визуализации и обработки 2D изображений в формате DICOM."
      },
      {
        ...
        description: "Ретрофит комплект с принадлежностями для модернизации любого аналогового рентген аппарата в цифровой вариант исполнения DR с функционалом много кадровой импульсной рентгеноскопии, с набором программных средств и модулем интеграции с МИС, собственной базой данных RIS/PACS/MIMPS, предназначенные для визуализации и обработки 2D изображений в формате DICOM."
      }
    ]
  },
  */
...
онкологической службе. Leica Aperio GT 450 DX: цифровые патоморфологические исследования с разрешением 26 мкм/пиксель при 40-кратном увеличении. PACS/RIS и MIMPS/RIS поддерживают DICOM. "LMS Мультивокс" подходят для работы.`,
  ...
  },
  {
    title: "Рентгеноскопическая цифровая DR система с искусственным интеллектом распознавания фотонов",
    subtitle: "Искусственный интеллект для врача радиолога",
    image: "./assets/images/cifroviesystem/product-07.jpg",
    description: `Ретрофит комплект с принадлежностями для модернизации любого аналогового рентген аппарата в цифровой вариант исполнения DR с функционалом много кадровой импульсной рентгеноскопии, с набором программных средств и модулем интеграции с МИС, собственной базой данных RIS/PACS/MIMPS, предназначенные для визуализации и обработки 2D изображений в формате DICOM.`,
    features: [
      { icon: "fa fa-globe", text: "Работа с изображениями для диагностики и хирургии" },
      { icon: "fa fa-code", text: "Собственный программный код" },
  ...
  // MULTIMODALARM
  {
    title: "АРМ врача-радиолога <br> с PACS и RIS с искусственным интеллектом диагностики ишемического инсульта «LMS Мультивокс ASPECTS»",
  ...
  {
    title: "АРМ врача-радиолога <br> с PACS и RIS с искусственным интеллектом, исследования лёгких по данным КТ за 60 секунд",
  ...
  {
    title: "АРМ врача-радиолога <br> с PACS и RIS для скрининга или диагностики при маммографии «LMS Мультивокс»",
...
Это интегрированное решение действует как автономная станция врача с собственной базой данных RIS, принимая информацию с лабораторных станций различных диагностических аппаратов.`,
  ...
  {
    title: "АРМ врача-радиолога диагноста <br> для аппаратов КТ, МРТ, ПЭТ-КТ",
    subtitle: "Экспертный класс",
  ...
  {
    title: "АРМ клинициста <br> «LMS Мультивокс П»",
    subtitle: "Экспертный класс",
  ...
  {
    title: "Сервер для телемедицинских телерадиологических консультаций <br> «LMS МультиТелеРад»",
  ...
  // PROGRAMMS
  {
    title: "Программа для телемедицинских и телерадиологических консультаций <br> «LMS МультиТелеРад»",
    subtitle: "Легкая модернизация",
  ...
  {
    title: "Программа RIS / PACS архивирования, управления и передачи медицинских изображений <br> «LMS МультиТелеРад»",
    subtitle: "Экспертный класс",
  ...
  {
    title: "Программа визуализации и обработки медицинских изображений в веб-браузере <br> «LMS Мультивокс WEB»",
    subtitle: "Легкая модернизация",
  ...
  {
    title: "Программа АРМ врача радиолога-диагноста <br> «LMS Мультивокс Д1»",
    subtitle: "Легкая модернизация",
  ...
  {
    title: "Программа АРМ врача радиолога-диагноста <br> «LMS Мультивокс Д2»",
    subtitle: "Легкая модернизация",
  ...
  },
  {
    ...
    subtitle: "Цифровые решения (ПО) для модернизации ваших лучевых установок (онкологических отделений)",
  ...
  {
    title: "Специализированные программы (ИИ)",
    subtitle: "Инновации для образования",
    image: "./assets/images/multimodalarm/product-09.jpg",
    description: `Комплексная система цифровой радиографии и флюороскопии, оснащенная передовыми алгоритмами искусственного интеллекта для распознавания фотонов и автоматической оптимизации изображений.`,
    features: [
    ...
    subProducts: [
      {
        title: "Программа для диагностики ишемического инсульта по данным КТ <br> «LMS Мультивокс ASPECTS» за 3 минуты",
        image: "./assets/images/programms/ai/product-01.jpg",
        description: "Программа «LMS MULTIVOX-ASPECTS» предназначена для работы врачей – специалистов по лучевой диагностике и врачей неврологов при оценке степени поражения головного мозга при ишемическом инсульте по изображениям, полученным на рентгеновских компьютерных томографах (КТ). Программа применяется для обработки, анализа и визуализации изображений, получаемых по протоколу DICOM."
      },
      {
        title: "Программа оценки степени поражения легких <br> «LMS COVID Мультивокс» за 90 секунд",
        image: "./assets/images/programms/ai/product-02.jpg",
        description: "Программа «LMS COVID-MULTIVOX» предназначена для работы врачей – радиологов и врачей анестезиологов-реаниматологов. Программа применяется для обработки, анализа и визуализации изображений, получаемых по протоколу DICOM. Программа оценки степени поражения легких «LMS COVID-MULTIVOX» основана на применении искусственного интеллекта."
      },
      {
      ...
      <div class="modal-body">
        ...
        <div class="modal-right">
          ...
          <div class="button-container">
            <a href="https://radiomics.kz/" class="button">
